        ...
        <form onSubmit={formik.handleSubmit}>
          <div className="mb-4">
            ...
            <PasswordInput
              ...
              {...formik.getFieldProps("PM_STRIP_SECRET_KEY")}
            />
          </div>
          <div className="mb-4">
            ...
            <PasswordInput
              ...
              {...formik.getFieldProps("PM_STRIP_SECRET_KEY_TEST")}
            />
          </div>
          ...
          <div className="d-flex">
            <Switch
              onChange={(checked) =>
                formik.setFieldValue("PM_STRIP_STATUS", checked)
              }
              name="accept"
              checked={formik.values.PM_STRIP_STATUS}
              size="small"
              className="mx-2 mt-1"
            />
            ...
            <label
              ...
              onClick={() =>
                formik.setFieldValue(
                  "PM_STRIP_STATUS",
                  !formik.values.PM_STRIP_STATUS,
                )
              }
            >
              {formik.values.PM_STRIP_STATUS ? "Active" : "Inactive"}
            </label>
          </div>
          ...
          <div className="d-flex">
            <Switch
              onChange={(checked) =>
                formik.setFieldValue("PM_STRIP_SANDBOX", checked)
              }
              name="accept"
              checked={formik.values.PM_STRIP_SANDBOX}
              size="small"
              className="mx-2 mt-1"
            />

            <label
              htmlFor="PM_STRIP_SANDBOX"
              className="form-label"
              onClick={() =>
                formik.setFieldValue(
                  "PM_STRIP_SANDBOX",
                  !formik.values.PM_STRIP_SANDBOX,
                )
              }
            >
              Sandbox{" "}
