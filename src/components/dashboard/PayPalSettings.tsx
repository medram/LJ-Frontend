        ...
        <form onSubmit={formik.handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              id="client-id"
              {...formik.getFieldProps("PM_PAYPAL_CLIENT_ID")}
            />
          </div>
          <div className="mb-4">
            ...
            <PasswordInput
              id="client-secret"
              placeholder=""
              {...formik.getFieldProps("PM_PAYPAL_CLIENT_SECRET")}
            />
          </div>
          ...
          <div className="d-flex">
            <Switch
              onChange={(checked: boolean) =>
                formik.setFieldValue("PM_PAYPAL_STATUS", checked)
              }
              name="accept"
              checked={formik.values.PM_PAYPAL_STATUS}
              size="small"
              className="mx-2 mt-1"
            />
            ...
            <label
              ...
              onClick={() =>
                formik.setFieldValue(
                  "PM_PAYPAL_STATUS",
                  !formik.values.PM_PAYPAL_STATUS,
                )
              }
            >
              {formik.values.PM_PAYPAL_STATUS ? "Active" : "Inactive"}
            </label>
          </div>
          ...
          <div className="d-flex">
            <Switch
              onChange={(checked: boolean) =>
                formik.setFieldValue("PM_PAYPAL_SANDBOX", checked)
              }
              name="accept"
              checked={formik.values.PM_PAYPAL_SANDBOX}
              size="small"
              className="mx-2 mt-1"
            />

            <label
              htmlFor="PM_PAYPAL_SANDBOX"
              className="form-label"
              onClick={() =>
                formik.setFieldValue(
                  "PM_PAYPAL_SANDBOX",
                  !formik.values.PM_PAYPAL_SANDBOX,
                )
              }
            >
              Sandbox{" "}
