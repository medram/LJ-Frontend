...
export default function GeneralSettings({ settings }) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      CURRENCY_POSITION: Yup.string().required(
  ...
  const defaultCurrencyPosition = {
    label: formik.values.CURRENCY_POSITION,
    ...
    <>
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="d-flex mb-5">
          <Switch
            onChange={(checked) => formik.setFieldValue("SHOW_LOGO", checked)}
            name="show-logo"
          ...
          <label
            ...
            onClick={() =>
              formik.setFieldValue("SHOW_LOGO", !formik.values.SHOW_LOGO)
            }
          >
            show logo instead of site name.
          </label>
        </div>
        ...
        <div className="row">
          <div className="mb-4">
            ...
            <small>
              <i>
                <b>Note:</b> keywords should be separated by comma "<b>,</b>".
              </i>
            </small>
          </div>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="form-control"
              id="site_desc"
              placeholder="A small description for Search Engins."
              {...formik.getFieldProps("SITE_DESC")}
            ></textarea>
          </div>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="form-control"
              id="head_code"
              placeholder="Any code added here will be injected between <head> tags (e.g. Javascript code)"
              {...formik.getFieldProps("HEAD_CODE")}
            ></textarea>
          </div>
        </div>
