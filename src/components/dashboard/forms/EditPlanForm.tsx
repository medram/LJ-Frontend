  ...
  return (
    <form onSubmit={formik.handleSubmit} autoComplete="off">
      ...
      <div className="d-flex mb-3">
        ...
        <label htmlFor="is_free" className="form-label">
          Free plan!
        </label>
      </div>
      ...
      <div className="d-flex mb-3">
        ...
        <label
          ...
          onClick={() =>
            formik.setFieldValue("is_popular", !formik.values.is_popular)
          }
        >
          set as popular (show popular mark)!
        </label>
      </div>
      ...
      {!!formik.values.paypal_plan_id && !formik.values.is_free && (
        <div className="mb-4">
          ...
          <input
            type="text"
            className="form-control"
            placeholder="e.g. P-6C235282FB245950NMRTE5II"
            id="paypal-plan-id"
            value={formik.values.paypal_plan_id}
            disabled
          />
        </div>
      )}
      ...
      {!!formik.values.stripe_plan_id && !formik.values.is_free && (
        <div className="mb-4">
          ...
          <input
            type="text"
            className="form-control"
            placeholder="e.g. price_1OgY8eCu5wfmOdwtc3h"
            id="stripe-plan-id"
      ...
      <div className="mb-4">
        <label htmlFor="pdfs">
          Max Documents <small>(0 = unlimited)</small>:
        </label>
        <input
          type="number"
          className="form-control"
          ...
          min={0}
          onChange={(e) =>
            formik.setFieldValue("pdfs", parseInt(e.target.value))
          }
        />
      </div>
      ...
      <div className="mb-4">
        <label htmlFor="pdf_size">
          Max Document Size (in MB) <small>(0 = unlimited)</small>:
        </label>
        <input
          type="number"
          className="form-control"
      ...
      <div className="mb-4">
        <label htmlFor="questions">
          Max Questions <small>(0 = unlimited)</small>:
        </label>
        <input
          type="number"
          className="form-control"
          ...
          min={0}
          onChange={(e) =>
            formik.setFieldValue("questions", parseInt(e.target.value))
          }
        />
      </div>
