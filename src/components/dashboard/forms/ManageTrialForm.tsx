  ...
  return (
    <form onSubmit={formik.handleSubmit} autoComplete="off">
      ...
      <Alert variant="info" className="mt-4">
        <Alert.Heading>
          <FontAwesomeIcon icon={faCircleInfo} /> Important
        </Alert.Heading>
        <p>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ea quidem,
          incidunt officia adipisci nihil eaque, repellat voluptatem quasi quo
          minus cum rerum earum accusantium! Vitae omnis aut rem aliquid
          blanditiis.
        </p>
      </Alert>
    </form>
