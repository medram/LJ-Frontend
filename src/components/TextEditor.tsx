...
const TINY_API_KEY =
  "ajele2r9opr9w00237cezbg50x5f0de6y3unf8pltinypbgd" as const;
    ...
    <>
      <Editor
        ...
        init={{
          ...
          toolbar:
            "blocks bold italic forecolor | alignleft aligncenter alignright alignjustify | link image media | bullist numlist table outdent indent | removeformat",
          ...currentInitProps,
        }}
        {...rest}
      />
