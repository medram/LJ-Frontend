      ...
      register(values)
        .then(({ data }) => {
          if (data.error === false) {
            ...
            if (redirectTo) return navigate(`/login?to=${redirectTo}`);
      ...
      <section className="container">
        <div className="row my-5 py-5">
          <div className="col-md-5 m-auto p-5">
            ...
            <span className="text-muted d-block text-center mb-5">
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <PasswordInput
                  id="password"
                  className="form-control"
                  placeholder="+6 character or more"
                  skipDemoMode
              ...
              <div className="d-flex mb-3">
                <Switch
                  onChange={(checked) =>
                    formik.setFieldValue("accept", checked)
                  }
                  name="accept"
                ...
                >
                  I read and accept terms of use & privacy policy of the
                  website.
                </label>
              </div>
