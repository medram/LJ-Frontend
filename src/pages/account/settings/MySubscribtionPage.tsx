    ...
    <div>
      ...
      {subscription ? (
        <div className="card">
          <div className="card-body">
            ...
            <p className="card-text">
              This subscription will be automatically renewed every{" "}
              {subscription.billing_cycle}.
            </p>

            <Link to="/pricing" className="btn btn-primary">
              <TablerIcon icon={IconBolt} stroke={1.25} /> Upgrade
            </Link>
          </div>
        </div>
      ) : (
        <>
          ...
          <br />
          <Link to="/pricing" className="btn btn-primary my-1">
            <FontAwesomeIcon icon={faRankingStar} /> Subscribe Now
          </Link>
        </>
      )}
    </div>
