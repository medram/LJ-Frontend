...
export function useModel() {
  ...
  const Model = useCallback(
    function ({ title, children, footer, center = true }: ModelProps) {
      return (
        <AnimatePresence>
          {isOpen && (
            <MotionModel
...
export function useLoginRegister() {
  ...
  const LoginRegisterModel = useCallback(
    ({ title, ...rest }: { title: string; [rest: string]: unknown }) => {
      return (
